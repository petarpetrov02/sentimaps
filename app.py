...
st.set_page_config(
    page_title="Sentimaps – Review Emotion & Sentiment Analyser",
    page_icon="sentimaps_icon.ico",  # Or "sentimaps_icon.png" if using your own image
    layout="wide",
...
with col1:
    st.image("sentimaps.png", width=70)
with col2:
    st.markdown(
        "<h1 style='margin-bottom: 0; color: #4B8BBE;'>Sentimaps by Petar Petrov</h1>"
        "<p style='margin-top: 0;'>Map emotions, sentiment, and guest experience with AI</p>",
